...
def about():
	st.write(
		...
		**Facial Emotion Recognition** 
        ...
        Custom Trained CNN model and Streamlit
...
def main():
    ...
    st.sidebar.markdown(
        """ Developed by Apoorva KR   
            Email : apoorvargowda1@gmail.com""")
    ...
    <body style="background-color:red;">
    <div style="background-color:red ;padding:10px">
    <h2 style="color:white;text-align:center;">Facial Emotion Recognition</h2>
    </div>
    </body>
        """
        st.markdown(html_temp, unsafe_allow_html=True)
    ...
    <h3 style="color:white;text-align:center;"> deployed by Apoorva KR </h3>
    </div>
    </body>
        """
        st.markdown(html_temp, unsafe_allow_html=True)
    ...
    <h1 style="color:white;text-align:center;">Facial Emotion Recognition</h1></div>
    
    <h2 style="text-align:center;"><b> This webapp shows realtime emotion recognition and realtime snapshot </h2></b>
    <h4 style="text-align:center;">
     <br><br><br>click on HOME from side bar</br></br></br>
    </h4>
    </center>
  </body>
        """
